...
<head>
    ...
    <title>Global Assist - Recuperar Clave</title>
            ...
            <div class="login-panel panel panel-default">
                <div class="panel-body">
                    <div class="row dflex">
                        ...
                        <div class="col-lg-6">
                            <h3 class="titulo">Cambiar Clave</h3>
                            <form role="form" method="post" action="<?php echo base_url(); ?>confirmar" id="formLogin">
                                <input type="hidden" name="id_clave" value="<?php echo $id; ?>">
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Ingrese nueva clave" name="newclave" type="password">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Repita nueva clave" name="rclave" type="password">
                                    </div>
        ...
        submitHandler: function(form) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (res.error == 0)
                    {
                        mostrarModalErrorVar('Cambiar Contraseña',res.mensaje);
                        setTimeout(function () {
