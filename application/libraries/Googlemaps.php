...
class Googlemaps {
	...
	var $center						= "-12.0677658,-77.0779969";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
